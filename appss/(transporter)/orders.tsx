    ...
    <SafeAreaView className="flex-1 bg-white">
      ...
      <View className="flex-row bg-white border-b border-gray-200">
        <TouchableOpacity
          ...
          className={`flex-1 py-4 ${activeTab === 'all' ? 'border-b-2 border-primary-500' : ''}`}
        >
          <Text className={`text-center font-montserrat-semibold ${
            activeTab === 'all' ? 'text-primary-500' : 'text-gray-600'
          }`}>
        ...
        <TouchableOpacity
          ...
          className={`flex-1 py-4 ${activeTab === 'active' ? 'border-b-2 border-primary-500' : ''}`}
        >
          <Text className={`text-center font-montserrat-semibold ${
            activeTab === 'active' ? 'text-primary-500' : 'text-gray-600'
          }`}>
        ...
        <TouchableOpacity
          ...
          className={`flex-1 py-4 ${activeTab === 'completed' ? 'border-b-2 border-primary-500' : ''}`}
        >
          <Text className={`text-center font-montserrat-semibold ${
            activeTab === 'completed' ? 'text-primary-500' : 'text-gray-600'
          }`}>
