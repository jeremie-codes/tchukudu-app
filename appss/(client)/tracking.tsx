  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      ...
      <View className="bg-white p-4 border-t border-gray-200">
        ...
        {/* Post-delivery actions (shown after delivery) */}
        <View className="flex-row space-x-3 mt-3 opacity-50">
          <TouchableOpacity className="flex-1 bg-yellow-500 rounded-xl py-3 flex-row items-center justify-center">
          ...
          <TouchableOpacity className="flex-1 bg-green-500 rounded-xl py-3 flex-row items-center justify-center">
